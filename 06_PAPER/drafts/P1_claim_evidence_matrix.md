...
| C1d | Literature: reconstructable VPR 2/38 (5.3%); W2 file/column confirmed 0/38; Table 2 W2↔obs skill 1/12 (Lima Neto 0.32); *R*² without NSE 9/11 | Literature gap | Table 2; Fig. 4 rug | `w5_lit_audit_summary.json`; `w5_lit_audit.csv` | Full text **9/38**; `unknown` not upgraded to absence |
