...
Cursor×ChatGPT maturation of `P1_GMD_draft_v2.md` (≥5 independent advisor rounds).  
...
- **Adopt:** soften invent/propose → operationalize W2-specific VPR/NHR/evaluation-object contract; matrix C1d = VPR-core; KEEP GMD Methods.
...
- **Adopt:** §3.3 scan paragraph; bounded sign-stability sentence; Appendix B table; Table 1 footnote; no Table 1 number change.
...
- **Adopt:** keep Abstract anchors (VPR-core + 1/7/4); KEEP Methods article type; DOI list PASS; Zenodo stays 待补充 with user steps.
...
1. **Zenodo DOI 待补充** — mint release archive; replace placeholder; GitHub alone ≠ GMD persistent archive.
